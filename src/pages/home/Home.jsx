...
export default function Home() {
    return (
        <>
        <main>
            <div className="hero d-flex flex-column justify-content-center" style={{ backgroundImage: `url("/img/kv-pslp-ordi-1-1.png")` , width: `100vw`, height: `94.1vh`, objectFit: `cover`}}>
